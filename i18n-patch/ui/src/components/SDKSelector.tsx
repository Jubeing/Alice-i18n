...
export interface SDKOption {
  ...
  name: string
  description: string
  nameKey?: string       // i18n key for name (overrides name if provided)
  descriptionKey?: string // i18n key for description (overrides description if provided)
  alwaysOnKey?: string   // i18n key for "always on" badge text
  comingSoonKey?: string // i18n key for "coming soon" badge text
...
export const CONNECTOR_OPTIONS: SDKOption[] = [
  {
    ...
    nameKey: 'webUi',
    descriptionKey: 'webUiDesc',
    alwaysOnKey: 'alwaysOn',
    badge: 'WB',
    badgeColor: 'text-accent',
    locked: true,
  },
